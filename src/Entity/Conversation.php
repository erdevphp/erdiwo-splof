...
#[ORM\Table(name: "Conversation", indexes: [new ORM\Index(name:"last_message_id_index", columns:["last_message_id"])])]
class Conversation
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(targetEntity: Participant::class, mappedBy: "conversation", cascade: ["remove"])]
